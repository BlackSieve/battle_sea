    ...
    while True:
        ...
        if game.status == 'in game':
            ...
            if shot_result == 'miss':
                ...
                game.current_player.message.append('Отличный выстрел капитан !')
                game.next_player.message.append('Наш корабль попал под обстрел!')
                continue
            elif shot_result == 'kill':
                game.current_player.message.append('Корабль врага уничтожен!')
                game.next_player.message.append('Капитан плохие новости, наш корабль был уничтожен ')
                continue
